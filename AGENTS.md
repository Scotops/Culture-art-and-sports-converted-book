# Culture, Art and Sports Pupil’s Book Standard One — ADT Bundle Reference
...
**Culture, Art and Sports Pupil’s Book Standard One** — This is a Tanzanian primary school textbook for Standard One, written in English, that introduces young learners to culture, art, and sports through simple, activity-based lessons. It covers traditional foods, clothing, music, dances, respect for religious differences, ethical behavior, basic art-making skills, songs and poems, and physical games and exercises. The book is clearly aimed at early elementary students and uses a practical, participatory approach that encourages pride in Tanzanian culture, cooperation, good manners, creativity, and physical development.

- **Source language**: `en-US`
- **Available languages in this bundle**: `en-US`
- **Total pages**: 174
- **Quizzes**: yes
- **Glossary**: yes
...
```
Utamaduni--ENGLISH--to-PRESS--Dec-6/
├── adt/                              # THE WEB APP
...
│   │   └── i18n/
│   │       └── {lang}/               # One directory per language: en-US
...
├── Utamaduni--ENGLISH--to-PRESS--Dec-6.db                    # SQLite database (pipeline state)
├── Utamaduni--ENGLISH--to-PRESS--Dec-6.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, for “Culture, Art and Sports Pupil’s Book Standard One,” approval number 1159, approved on October 23, 2023, and signed by the Commissioner for Education.",
  "gl001": "according to",
  "gl001_def": "following rules, instructions, or what is said",
  "qz001_que": "What is one thing shown as part of our culture in these pages?",
  "qz001_o0": "1) Cars",
  "qz001_o0_exp": "❌ Not quite. The pages are about culture and traditional foods, not cars."
}
```
...
```json
{
  "according to": {
    "word": "according to",
    "definition": "following rules, instructions, or what is said",
...
```json
{
  "title": "Culture, Art and Sports Pupil’s Book Standard One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-US"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is one thing shown as part of our culture in these pages?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. The pages are about culture and traditional foods, not cars." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Cars</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `Utamaduni--ENGLISH--to-PRESS--Dec-6.pdf` |
| Pipeline database | `Utamaduni--ENGLISH--to-PRESS--Dec-6.db` (SQLite) |
